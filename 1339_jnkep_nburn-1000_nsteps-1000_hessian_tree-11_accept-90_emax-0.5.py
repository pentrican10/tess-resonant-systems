...
print(popt)
print(param_bounds)
with open('1339_jnkep_initial_fit_data_hessian_tree-11_accept-90_emax-0.5_RV.pkl', 'wb') as f:
...
import dill
with open("1339_jnkep_nburn-1000_nsteps-1000_hessian_tree-11_accept-90_emax-0.5.pkl", "wb") as f:
    dill.dump(mcmc, f)
