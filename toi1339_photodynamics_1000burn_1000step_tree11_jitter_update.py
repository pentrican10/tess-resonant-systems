...
def model_fix_ttv(par_dict, param_bounds_transit):
    ...
    gp = tinygp.GaussianProcess(kernel, nt.times_lc, diag=error_obs**2 + jitter_per_point**2, mean=0.0)
...
import pickle 
with open('1339_jnkep_initial_fit_photodyn_tree11_jitter_update.pkl', 'wb') as f:
    pickle.dump({'nt': nt, 
...
# save output
import dill
with open("toi1339_photodynamics_1000burn_1000step_tree11_jitter_update.pkl", "wb") as f:
    dill.dump(mcmc, f)
