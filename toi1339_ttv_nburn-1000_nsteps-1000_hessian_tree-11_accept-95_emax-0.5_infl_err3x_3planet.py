...
period_guess = [8.88020257, 28.579657965796578, 38.35013501350135]
for j in range(3):
...
t_end = 3670.
dt = period_guess[0] / 40. # integration timestep
...
### fit
popt = ttv_optim_curve_fit(jttv,param_bounds, plot=False)
# plt.show()
print(popt)
...
print(popt)
print(param_bounds)
with open('toi1339_ttv_initial_fit_data_hessian_tree-11_accept-95_emax-0.5_infl_err3x_3planet.pkl', 'wb') as f:
...
import dill
with open("toi1339_ttv_nburn-1000_nsteps-1000_hessian_tree-11_accept-95_emax-0.5_infl_err3x_3planet.pkl", "wb") as f:
    dill.dump(mcmc, f)
